...
char nomes[20][20] = {"maca", "bananaa", "pera", "uvaa", "laranja", "abacaxi", "limao", "manga", "abacate", "kiwi", "cereja", "morango", "pessego", "goiaba", "melanciaa", "framboesa", "amora", "caqui", "figo", "papaya"};
